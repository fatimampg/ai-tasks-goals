     ...
     <div className="modal__container">
       ...
       <div className="modal__info-key-value">
         ...
         <input
           ...
           value={new Date(updatedDeadline).toISOString().split("T")[0]} //ensure updatedDeadline is Date obj, to ISOString ("YYYY-MM-DDTHH:mm:ss.sssZ") and select the 1st part of Date (before T) (result: "YYYY-MM-DD")
           onChange={(e) => {
